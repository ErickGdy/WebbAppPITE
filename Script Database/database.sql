...
/****** Object:  Database [webApp]    Script Date: 06/03/2019 4:13:16 ******/
CREATE DATABASE [webApp]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'webApp', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\webApp.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'webApp_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\webApp_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [webApp] SET COMPATIBILITY_LEVEL = 140
GO
